...
var user;
var user_data = [];
var Logprocess = require("../../model/logprocess_model");
router.get("/", (req, res) => {
  ...
  async function Gethistory() {
    ...
    try {
      const result = await Logprocess.find();
      history = result;
    } finally {
      console.log(history);
...
router.post("/editmember", (req, res) => {
  ...
  async function updateMember() {
    try {
      ...
      const result = await Logprocess.updateOne(query, value);
    } finally {
...
router.get("/del/:id", function (req, res) {
  ...
  async function getUser() {
    try {
      const result = await Logprocess.deleteOne({
        _id: ObjectId(id),
      });
    } catch (err) {
      console.log(err);
...
router.post("/insertmember", (req, res) => {
  ...
  async function insertMember() {
    try {
      ...
      const result = await Logprocess.insertOne(doc);
    } finally {
